...
from agent_framework.security import ContentLabel, IntegrityLabel, PolicyEnforcementFunctionMiddleware
...
async def test_policy_reapproval_is_visible_persisted_and_executes_once(
    ...
    assert [snapshot["id"] for snapshot in pending_snapshots] == [occurrence_id]
